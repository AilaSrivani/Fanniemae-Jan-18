...
public class ObjectMappingWorkflowPageActions {
	...
	public ObjectMappingWorkflowPageActions(ObjectMappingWFTest objectMappingWFTest, WebDriver driver){
		super();
		this.driver = driver;
	...
	public void objectMappingWorkflow(String testCaseName,String serialNo,String sheetName) {
		try {
			
			WebElementOperations.click(driver, ObjectmappingWorkflowWebelements.administration);
			WebElementOperations.park(2);
			click(driver, ObjectmappingWorkflowWebelements.objectMappingWorkflowHeader);
			park(2);
			...
			LOG.error("Failed to object mapping",e);
		}
	}
